...
public class AppMinisterio extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form AppMinisterio
     */
    public AppMinisterio(javax.swing.JDesktopPane desktopPane) {
        super();
        initComponents();
    ...
    private void jMenuItemEncuestaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemEncuestaActionPerformed
        ...
        EncuestaMinisterio encuesta = new EncuestaMinisterio(this);
        encuesta.setTitle(titulo);
        panelDesktop.add(encuesta);
    ...
    private void jMenuItemAcercaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAcercaActionPerformed
        ...
        AyudaMinisterio ayuda = new AyudaMinisterio();
        ayuda.setTitle(titulo);
        panelDesktop.add(ayuda);
