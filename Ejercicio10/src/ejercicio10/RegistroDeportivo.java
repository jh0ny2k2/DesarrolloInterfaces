...
public class RegistroDeportivo extends javax.swing.JInternalFrame {
     ...
     */
    public RegistroDeportivo(javax.swing.JDesktopPane desktopPane) {
        super();
        initComponents();
        inicializarTabla();
    ...
    private void jButtonAddHijoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddHijoActionPerformed
        ...
        AddHijo hijo = new AddHijo(this);
        hijo.setTitle(titulo);
        panelDesktop.add(hijo);
